...
if (!phoneRegex.test(cleanedPhone)) {
  alert("Please enter a valid phone number. Must be 10 digits starting with 078, 079, 072, or 073.");
  return;
}

// Optional: You can also provide more specific error messages
if (cleanedPhone.length !== 10) {
  alert("Phone number must be exactly 10 digits.");
  return;
}

if (!cleanedPhone.match(/^(078|079|072|073)/)) {
  alert("Phone number must start with 078, 079, 072, or 073.");
  return;
}
